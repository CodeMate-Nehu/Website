...
const AlumniDetailed = () => {
  ...
  const alumni = {
    ...
    internships:
      found.internships !== undefined ? found.internships : "missing data",
    papers: found.papers !== undefined ? found.papers : "missing data",
    expertise:
      found.expertise &&
      Array.isArray(found.expertise) &&
      found.expertise.length > 0
        ? found.expertise
        : ["missing data"],
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 rounded-3xl overflow-hidden border border-zinc-200 shadow-2xl bg-white">
          ...
          <div className="lg:col-span-4 bg-brand-orange-bg p-8 sm:p-10 flex flex-col items-center text-center text-black">
            ...
            {(alumni.role !== "missing data" ||
              alumni.company !== "missing data") && (
              <div className="bg-black text-white text-[10px] font-bold px-4 py-1.5 rounded-full mb-3 uppercase tracking-wider">
                {alumni.role !== "missing data" ? alumni.role : ""}
                {alumni.role !== "missing data" &&
                alumni.company !== "missing data"
                  ? " @ "
                  : ""}
                {alumni.company !== "missing data" ? alumni.company : ""}
              </div>
            )}
            {alumni.batch !== "missing data" && (
            ...
            {/* Expertise grid */}
            {alumni.expertise[0] !== "missing data" && (
          ...
          <div className="lg:col-span-8 bg-zinc-50 p-8 sm:p-12 text-black flex flex-col justify-between gap-10">
            ...
            <div className="space-y-8">
              {/* Metrics cards grid */}
              {(alumni.internships !== "missing data" ||
                alumni.papers !== "missing data" ||
                alumni.openSource !== "missing data") && (
